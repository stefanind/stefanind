...
- Built GPT-2 (with some GPT-3 specs) because I wanted to understand everything about how LLM's work. I am always thinking about making additions to it.
  - Next add-on: FSDP for training across GPUs.
  - Next add-on: optimizing inference runtime.
- Building DreamerV3 from scratch in PyTorch because I want to understand world models using RL (currently paused due to interest in CUDA).
