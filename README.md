...
I am currently doing a Master's in Data Science (graduating June 2026), specializing in Machine Learning. I spend all my extra time learning about LLMs, ML, world models, and systems-level & performance AI engineering.

I am also conducting some research by investigating representational priors for efficient transformer training. Basically, I am trying to extract a prior from a trained model (knowledge distillation) to be used as a basis for new models to reduce training time and help model convergence. 
